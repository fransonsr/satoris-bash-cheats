...
export RS_SOURCE_VERSION=0.2.4
...
export RS_PERSISTENCE_PROJECTS="cds2-root cds-journal-worker cds-sls-model cds-to-gedcomx gedcomx-builder ram ramsak recapi sls-consumers sls-persistence"
